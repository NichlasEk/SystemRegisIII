...
static int RunBios(string[] args)
{
    ...
    var postAuthTrace = new List<string>(1024);
    ...
    for (var i = 0; i < instructionCount; i++)
    {
        ...
        if (postAuthTraceArmed && postAuthTrace.Count < 1024)
        {
