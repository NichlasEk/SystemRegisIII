...
- probe why the mounted real-disc path does not yet issue TOC/file/sector commands; likely next suspects are richer CD Block status phase transitions, boot/security-ring response shape, or BIOS conditions before filesystem reads
